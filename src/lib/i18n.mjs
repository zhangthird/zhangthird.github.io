...
export const messages = {
  ...
  'search.note': ['Note', '文章'],
  'math.title': ['Copy formula', '复制公式'],
  'math.close': ['Close formula panel', '关闭公式面板'],
  'math.tex': ['Copy LaTeX', '复制 LaTeX'],
  'math.markdown': ['Copy Markdown', '复制 Markdown'],
  'math.viewSource': ['View source', '查看源码'],
  'math.source': ['Formula source', '公式源码'],
